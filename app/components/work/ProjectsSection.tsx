        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {projects.map((project) => {
            ...
            return (
              <article
                key={project.id}
                className="rounded-[2rem] border border-slate-200 bg-white p-6 text-center shadow-sm transition hover:-translate-y-1 hover:shadow-md sm:text-left"
              >
                ...
                <a href={project.href} className="mt-6 inline-flex min-h-10 items-center text-sm font-semibold text-sky-600 transition hover:text-sky-800">
                  {t.viewDetails}
                </a>
              </article>
            );
