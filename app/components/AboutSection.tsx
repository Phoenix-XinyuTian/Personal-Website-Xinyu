...
// Restrained CTA pill: subtle grey border + white bg, theme-blue on hover.
const ctaClass =
  "inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-sm text-slate-700 transition-all duration-150 hover:border-sky-300 hover:text-sky-600";
