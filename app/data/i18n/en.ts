export const en = {
  ...
  focusAreasWork: [
    {
      ...
      description: "Segmentation, anomaly detection, and industrial inspection.",
    },
    {
      icon: "🤖",
    ...
    },
    {
      icon: "🛠️",
      title: "Build & Ship",
      description: "Side projects and open-source work — from ML demos and tools to this site itself.",
    },
  ],
  focusAreasLife: [
    {
      ...
      description: "Turning experiences into stories through videos, writing and digital media.",
    },
    {
      icon: "🌍",
      title: "World Travel",
      description: "Exploring different cultures, cities and ways of life through travel and study abroad.",
    },
    {
      icon: "📚",
      title: "Lifelong Growth",
      description: "Documenting the journey of learning, building and becoming a better version of myself.",
    },
  ],
  ...
  news: {
    ...
    workItems: [
      ...
      { date: "2025-08", title: "Started MSc Physics for Technology at NUS" },
